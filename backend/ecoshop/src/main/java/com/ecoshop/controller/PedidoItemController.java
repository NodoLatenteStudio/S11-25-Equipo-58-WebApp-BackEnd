 ...
 * 
 * Convenciones REST:
 * - POST /api/v1/pedido-items: Agregar un item a un pedido (201 Created)
 * - GET /api/v1/pedido-items/pedido/{pedidoId}: Obtener todos los items de un pedido (200 OK)
 * - PUT /api/v1/pedido-items/{itemId}: Actualizar la cantidad de un item (200 OK)
 * - DELETE /api/v1/pedido-items/{itemId}: Eliminar un item de un pedido (204 No Content)
 * 
 * Validación:
