package com.ecoshop.repository.pedido;
...
public interface PedidoRepository extends JpaRepository<Pedido, Integer> {
    ...
    /**
     * Busca todos los pedidos de un usuario en un rango de fechas.
     * 
     * @param usuarioId ID del usuario
     * @param fechaInicio Fecha de inicio del rango (inclusive)
     * @param fechaFin Fecha de fin del rango (inclusive)
     * @return Lista de pedidos del usuario en el rango de fechas
     */
    List<Pedido> findByUsuario_UsuarioIdAndFechaPedidoBetween(
            Integer usuarioId, 
            LocalDateTime fechaInicio, 
            LocalDateTime fechaFin);

    /**
     * Busca un pedido por el ID de transacción de pago.
     * 
     * @param idTransaccionPago ID de la transacción de pago
     * @return Optional con el pedido si existe
     */
    java.util.Optional<Pedido> findByIdTransaccionPago(String idTransaccionPago);
}
