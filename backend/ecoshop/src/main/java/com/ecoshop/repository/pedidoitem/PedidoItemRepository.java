package com.ecoshop.repository.pedidoitem;
...
public interface PedidoItemRepository extends JpaRepository<PedidoItem, Integer> {
    ...
    /**
     * Busca todos los items de pedidos que contienen productos de una marca específica.
     * 
     * @param marcaId ID de la marca
     * @return Lista de items que incluyen productos de la marca
     */
    @Query("SELECT pi FROM PedidoItem pi WHERE pi.producto.marca.marcaId = :marcaId")
    List<PedidoItem> findByProducto_Marca_MarcaId(@Param("marcaId") Integer marcaId);
}
