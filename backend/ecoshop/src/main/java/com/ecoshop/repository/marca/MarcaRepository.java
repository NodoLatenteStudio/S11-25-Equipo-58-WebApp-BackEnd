package com.ecoshop.repository.marca;
...
public interface MarcaRepository extends JpaRepository<Marca, Integer> {
    ...
    /**
     * Busca marcas por nombre oficial (búsqueda parcial, case-insensitive).
     * 
     * @param nombreOficial Nombre o parte del nombre oficial a buscar
     * @return Lista de marcas que coinciden con el nombre
     */
    List<Marca> findByNombreOficialContainingIgnoreCase(String nombreOficial);
}
